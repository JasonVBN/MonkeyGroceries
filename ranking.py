'''
Function 1: Take in the dictionary given by the Gmail API
parse through and submit in string format to the AI call.
LLM will process the locations and give back certain locations depending on the product you are looking for
'''



'''
Function 2: Convert the string returned by the LLM and convert the string to a dictionary 
(or whatever format preferred by the LLM)
'''


'''
Function 3: Take in multiple 
'''
# functions.py
